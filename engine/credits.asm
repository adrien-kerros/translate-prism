...
.initial_1
	ctxt "Beaucoup d'ano-"
	next "nymes ont travai-"
	next "llés sur ce jeu."
	done

.initial_2
	ctxt "Nous utilisons ces"
	next "crédits pour re-"
	next "mercier certains."
	done

.kbm_1
	ctxt "Merci à"
	next "Koolboyman,"
	next "d'avoir créé la"
	done

.kbm_2
	ctxt "version originale"
	next "de ce jeu,"
	next "pendant 8 ans."
	done

.original_devs_1
	ctxt "Merci à l'équipe"
	next "de développement"
	next "originale, qui a"
	done

.original_devs_2
	ctxt "rendu ce jeu"
	next "possible et"
	next "presque terminé."
	done

.leakers_1
	ctxt "Merci à ceux ayant"
	next "divulgué le jeu,"
	next "tout le monde peut"
	done

.leakers_2
	ctxt "encore jouer et"
	next "nous pouvons"
	next "développer dessus."
	done

.game_freak_1
	ctxt "Merci à Game Freak"
	next "ainsi qu'à leurs"
	next "collaborateurs,"
	done

.game_freak_2
	ctxt "pour avoir créé"
	next "cette franchise"
	next "incroyable."
	done

.game_freak_3
	ctxt "Surtout, achetez"
	next "leurs excellents"
	next "jeux."
	done

.you
	ctxt "Enfin, merci à"
	next "vous d'avoir joué"
	next "à ce jeu !"
	done
